...
- (void)initService {
    ...
    [JLNetworkTool requestRongAppIDWithSuccess:^(NSDictionary * _Nonnull result) {
        ...
        [strongweakself rongCloundEngineInit:rongAppID];
    ...
    [JLNetworkTool requestRonngUserTokenWithSuccess:^(NSDictionary * _Nonnull result) {
        StrongSelf(weakself);
        [strongweakself rongCloundConnect:result[@"data"]];
    ...
    if ([message.content isKindOfClass:[JLHeartBeatMessage class]]) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if ([message.content isKindOfClass:[JLHeartBeatMessage class]]) {
                ...
                [[JLIMService currentViewController] presentViewController:controller animated:YES completion:^{
