...
- (void)setModel:(JLFansModel *)model{
    ...
    if ([model.followFlag isEqualToString:@"1"]) {
        [self.followBtn setImage:[UIImage imageNamed:@"jl_video_play"] forState:UIControlStateNormal];
        ...
        [self.followBtn setImage:[UIImage imageNamed:@"jl_follow_add"] forState:UIControlStateNormal];
