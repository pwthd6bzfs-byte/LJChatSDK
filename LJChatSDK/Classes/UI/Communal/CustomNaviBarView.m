...
-(UIButton *) backButton
{
    if (!_backButton)
    {
        ...
        [_leftButton setImage:[UIImage imageNamed:@"navBackBlackIcon"] forState:UIControlStateNormal];
        [_leftButton setImage:[UIImage imageNamed:@"navBackBlackIcon"] forState:UIControlStateHighlighted];
