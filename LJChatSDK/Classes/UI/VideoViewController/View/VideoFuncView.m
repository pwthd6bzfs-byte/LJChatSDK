...
@interface VideoFuncView ()<UITableViewDelegate,UITableViewDataSource,JLIMServiceDelegate>
...
- (void)setIsHeartMatch:(BOOL)isHeartMatch{
    if (isHeartMatch == YES) {
        ...
        self.roomTagIcon.image = [UIImage imageNamed:@"jl_heartMatch"];
...
- (UIView *)roomTagView{
    if (!_roomTagView) {
        ...
        iconImg.image = [UIImage imageNamed:@"jl_video"];
...
- (UIButton *)followBtn{
    if (!_followBtn) {
        ...
        [view setImage:[UIImage imageNamed:@"jl_follow_add"] forState:UIControlStateNormal];
        [view setImage:[UIImage imageNamed:@"jl_follow_no"] forState:UIControlStateSelected];
...
- (UIButton *)logoutBtn{
    if (!_logoutBtn) {
        UIButton *view = [[UIButton alloc] init];
        [view setImage:[UIImage imageNamed:@"jl_close"] forState:UIControlStateNormal];
...
- (UIImageView *)countdownImageView{
    if (!_countdownImageView) {
        UIImageView *view = [[UIImageView alloc] init];
        view.contentMode = UIViewContentModeScaleAspectFill;
        view.image = [UIImage imageNamed:@"jl_countDown"];
