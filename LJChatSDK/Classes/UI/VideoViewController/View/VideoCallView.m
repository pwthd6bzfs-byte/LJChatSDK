...
- (UIImageView *)coinImageView{
    if (!_coinImageView) {
        UIImageView *view = [[UIImageView alloc] init];
        view.image = [UIImage imageNamed:@"jl_coin"];
        view.contentMode = UIViewContentModeScaleAspectFill;
        _coinImageView = view;
    }
...
- (UILabel *)explainLab{
    if (!_explainLab) {
        ...
        view.text = @"对方接受后开始计费，不足1分钟按1分钟计费";
...
- (UIButton *)cameraBtn{
    if (!_cameraBtn) {
        ...
        [view setImage:[UIImage imageNamed:@"jl_camera"] forState:UIControlStateNormal];
        [view setImage:[UIImage imageNamed:@"jl_camera_no"] forState:UIControlStateSelected];
...
- (UIButton *)microphoneBtn{
    if (!_microphoneBtn) {
        UIButton *view = [[UIButton alloc] init];
        [view setImage:[UIImage imageNamed:@"jl_microphone"] forState:UIControlStateNormal];
        [view setImage:[UIImage imageNamed:@"jl_microphone_no"] forState:UIControlStateSelected];
...
- (UIButton *)reverseBtn{
    if (!_reverseBtn) {
        UIButton *view = [[UIButton alloc] init];
        [view setImage:[UIImage imageNamed:@"jl_reverse"] forState:UIControlStateNormal];
        [view setImage:[UIImage imageNamed:@"jl_reverse_no"] forState:UIControlStateSelected];
...
- (UIButton *)cancelBtn{
    if (!_cancelBtn) {
        UIButton *view = [[UIButton alloc] init];
        [view setImage:[UIImage imageNamed:@"jl_call_cancel"] forState:UIControlStateNormal];
