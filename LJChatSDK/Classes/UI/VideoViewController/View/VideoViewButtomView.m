...
- (UIButton *)reverseBtn{
    if (!_reverseBtn) {
        UIButton *btn = [[UIButton alloc] init];
        btn.backgroundColor = [UIColor clearColor];
        [btn setImage:[UIImage imageNamed:@"jl_reverse_no"] forState:UIControlStateNormal];
...
- (UIButton *)cameraBtn{
    if (!_cameraBtn) {
        UIButton *btn = [[UIButton alloc] init];
        btn.backgroundColor = [UIColor clearColor];
        [btn setImage:[UIImage imageNamed:@"jl_room_camera"] forState:UIControlStateNormal];
        [btn setImage:[UIImage imageNamed:@"jl_room_camera_no"] forState:UIControlStateSelected];
...
- (UIButton *)microphoneBtn{
    if (!_microphoneBtn) {
        UIButton *btn = [[UIButton alloc] init];
        btn.backgroundColor = [UIColor clearColor];
        [btn setImage:[UIImage imageNamed:@"jl_room_microphone"] forState:UIControlStateNormal];
        [btn setImage:[UIImage imageNamed:@"jl_room_microphone_no"] forState:UIControlStateSelected];
...
- (UIButton *)giftBtn{
    if (!_giftBtn) {
        UIButton *btn = [[UIButton alloc] init];
        btn.backgroundColor = [UIColor clearColor];
        [btn setImage:[UIImage imageNamed:@"jl_gift_video"] forState:UIControlStateNormal];
