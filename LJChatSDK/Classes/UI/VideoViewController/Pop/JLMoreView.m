...
- (void)setup{
    ...
    imgCamera.image = [UIImage imageNamed:@"jl_camera_video"];
    ...
    [swcCamera setImage:[UIImage imageNamed:@"jl_switch_on"] forState:UIControlStateNormal];
    [swcCamera setImage:[UIImage imageNamed:@"jl_switch_off"] forState:UIControlStateSelected];
    ...
    imgMicro.image = [UIImage imageNamed:@"jl_microphone_video"];
    ...
    [swcMicro setImage:[UIImage imageNamed:@"jl_switch_on"] forState:UIControlStateNormal];
    [swcMicro setImage:[UIImage imageNamed:@"jl_switch_off"] forState:UIControlStateSelected];
