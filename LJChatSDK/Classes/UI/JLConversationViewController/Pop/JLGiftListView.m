...
- (void)setupModel:(JLGiftListModel *)model{
    ...
    iconView.image = [UIImage imageNamed:@"jl_coin"];
    ...
    iconArrowView.image = [UIImage imageNamed:@"jl_arrow"];
...
//    self.listTableView = tableView;
    ...
    [addBtn setImage:[UIImage imageNamed:@"jl_add"] forState:UIControlStateNormal];
    ...
    [reduceBtn setImage:[UIImage imageNamed:@"jl_reduce"] forState:UIControlStateNormal];
