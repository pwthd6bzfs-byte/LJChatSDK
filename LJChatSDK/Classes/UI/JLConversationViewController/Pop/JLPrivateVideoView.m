...
- (void)setupModel:(JLMediaPrivateMessage *)message{
    ...
    [playBtn setImage:[UIImage imageNamed:@"jl_play"] forState:UIControlStateNormal];
    ...
    [closeBtn setImage:[UIImage imageNamed:@"navBackBlackIcon"] forState:UIControlStateNormal];
    ...
    [markBtn setImage:[UIImage imageNamed:@"jl_mark"] forState:UIControlStateNormal];
