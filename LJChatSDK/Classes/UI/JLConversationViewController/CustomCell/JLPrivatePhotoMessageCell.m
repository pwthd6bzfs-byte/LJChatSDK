...
- (void)viewed{
    ...
    self.iconImageView.image = [UIImage imageNamed:@"jl_viewed"];
...
- (void)expired{
    ...
    self.iconImageView.image = [UIImage imageNamed:@"jl_expired"];
...
- (void)unlock{
    ...
    self.iconImageView.image = [UIImage imageNamed:@"jl_lock"];
...
- (UIImageView *)iconImageView{
    if (!_iconImageView) {
        ...
        view.userInteractionEnabled = NO;
        view.contentMode = UIViewContentModeScaleAspectFill;
        view.image = [UIImage imageNamed:@"jl_lock"];
        _iconImageView = view;
    }
...
- (UIImageView *)playImageView{
    if (!_playImageView) {
        ...
        view.image = [UIImage imageNamed:@"jl_play"];
        _playImageView = view;
    }
