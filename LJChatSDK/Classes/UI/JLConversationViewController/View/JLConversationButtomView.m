...
- (void)clickLeftBtnEvent{
    ...
    if (self.leftBtn.selected == YES) {
        [self.leftBtn setImage:[UIImage imageNamed:@"jl_record1"] forState:UIControlStateNormal];
        self.recordBtn.hidden = NO;
    }else{
        [self.leftBtn setImage:[UIImage imageNamed:@"jl_record"] forState:UIControlStateNormal];
...
- (UIButton *)leftBtn{
    if (!_leftBtn) {
        ...
        [btn setImage:[UIImage imageNamed:@"jl_record"] forState:UIControlStateNormal];
        [btn setImage:[UIImage imageNamed:@"jl_keyboard"] forState:UIControlStateSelected];
...
- (UIButton *)sendBtn{
    if (!_sendBtn) {
        UIButton *btn = [[UIButton alloc] init];
        btn.backgroundColor = [UIColor clearColor];
        [btn setImage:[UIImage imageNamed:@"jl_send"] forState:UIControlStateNormal];
...
- (UIButton *)photoBtn{
    if (!_photoBtn) {
        UIButton *btn = [[UIButton alloc] init];
        btn.backgroundColor = [UIColor clearColor];
        [btn setImage:[UIImage imageNamed:@"jl_photo"] forState:UIControlStateNormal];
...
- (UIButton *)emojiBtn{
    if (!_emojiBtn) {
        UIButton *btn = [[UIButton alloc] init];
        btn.backgroundColor = [UIColor clearColor];
        [btn setImage:[UIImage imageNamed:@"jl_emoji"] forState:UIControlStateNormal];
...
- (UIButton *)telBtn{
    if (!_telBtn) {
        UIButton *btn = [[UIButton alloc] init];
        btn.backgroundColor = [UIColor clearColor];
        [btn setImage:[UIImage imageNamed:@"jl_tel"] forState:UIControlStateNormal];
...
- (UIButton *)giftBtn{
    if (!_giftBtn) {
        UIButton *btn = [[UIButton alloc] init];
        btn.backgroundColor = [UIColor clearColor];
        [btn setImage:[UIImage imageNamed:@"jl_gift"] forState:UIControlStateNormal];
